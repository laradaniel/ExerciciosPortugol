programa
{
	...
	funcao inicio()
	{
		...
		se o índice atingir 0,5 todos os grupos devem ser notificados a paralisarem suas atividades. Faça um sistema
		...
		*/
		...
		senao se(indice<=0.3){
			escreva("Nível de poluição acima do esperado. Indústrias do 1º grupo devem suspender suas atividades.")
		}
		senao se(indice<=0.4){
			escreva("Nível de poluição acima do esperado. Indústrias do 1º e 2º grupo devem suspender suas atividades.")
		}
		senao se(indice<=0.5){
			escreva("Nível de poluição acima do esperado. Todos os grupos devem paralisar suas atividades.")
		}
		senao{
			escreva("Valor digitado fora do índice.")
		}
	}
}
/* $$$ Portugol Studio $$$ 
